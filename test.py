...
layout2 = [[sg.Table(values = arr1, headings=enviroHeadings, vertical_scroll_only=True, alternating_row_color='lightBlue')],
           [sg.Button('Register')],
...
windowLayout = [[sg.Menu(top_menu_def)],
    [sg.TabGroup([[sg.Tab('Device Data', layout1, font='Helvetica'),
